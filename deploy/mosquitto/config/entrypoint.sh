...
#    Mosquitto broker.
# 2. Generates /mosquitto/config/passwd at runtime from the 8 per-client
...
for user in MKR1000 ESP32CAM BACKEND NODERED LLMGATEWAY DIGITALTWIN COAPBRIDGE MQTTTOINFLUX; do
