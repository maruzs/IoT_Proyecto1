 ...
 *
 * Centralized constants: pins, EQUIPO_ID, and MQTT topic macros.
 * Thresholds belong in Node-RED — the MKR1000 is a dumb sensor/actuator.
...
// Identity
// ---------------------------------------------------------------------------
#define EQUIPO_ID "equipo69" // Cambia XX por tu número de equipo
