import { apiGet, apiPost, formatTimestamp } from './api.js';
...
export function init() {
    eventIntervalId = setInterval(updateDetectionCard, POLL_EVENT);
    logIntervalId = setInterval(updateAccessLog, POLL_LOG);
