...
El monitoreo ambiental y las reglas de seguridad automáticas se ejecutan de forma paralela e independiente en Node-RED. La secuencia lógica describe el flujo desde que los sensores físicos leen las variables ambientales hasta la activación de alertas y notificaciones.
